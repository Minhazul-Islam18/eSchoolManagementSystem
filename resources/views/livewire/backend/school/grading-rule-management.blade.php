    ...
    <main class="container">
                ...
                <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);" x-cloak
                    ...
                    <div class="flex items-center justify-between space-x-4">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                            {{ $this->editable_item ? 'Edit' : 'Create' }} grade rule
                        </h3>
                                    ...
                                    <div class="p-6 space-y-6 h-full">
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div class="">
                                                ...
                                                <input wire:model.blur='point' type="number"
                                                    class="form-input rounded placeholder:text-gray-300"
                                                    placeholder="3.5, 4.0, 4.67 ..." id="">
                                                @error('point')
                                            ...
                                            <div class="">
                                                ...
                                                <input wire:model.blur='grade' type="text"
                                                    class="form-input rounded placeholder:text-gray-300"
                                                    placeholder="A+, A- ..." id="">
                                                @error('grade')
                                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                            ...
                                            <div class="">
                                                <label for="" class="form-label">Starts</label>
                                                <input wire:model.blur='starts_at' type="number"
                                                    placeholder="70, 80 ..."
                                                    class="form-input rounded placeholder:text-gray-300" id="">
                                                @error('starts_at')
                                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="">
                                                <label for="" class="form-label">Ends</label>
                                                <input wire:model.blur='ends_at' type="number" placeholder="80, 90 ..."
                                                    class="form-input rounded placeholder:text-gray-300" id="">
                                                @error('ends_at')
                                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                                @enderror
        ...
        <div wire:ignore>
            <table id="example" class="display" style="width: 100%">
                ...
                <tbody>
                    @foreach ($this->allRules as $key => $item)

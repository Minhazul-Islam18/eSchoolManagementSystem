                    ...
                    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);" x-cloak
                        ...
                        <div class="flex items-center justify-between space-x-4">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                ...
                                Group: {{ $this->routine_for['group'] ?? 'Loading...' }}
                            </h3>
                                            ...
                                            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                                <div class="overflow-hidden">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr wire:loading wire:target="showFullRoutine"
                                                                class=" block text-center py-3 text-md">
                                                                <td class="py-3 px-1">
                                                                    Loading...</td>
                                                            </tr>
                                                            ...
                                                            @empty
                                                                <tr wire:loading.class='hidden'
                                                                    ...
                                                                    <td class="py-3 px-1">
                                                                        <span class=" ">No routines added for this
                                                                            selected
                                                                            class group.</span>
                                                                    </td>
                                                                </tr>
                                            ...
                                            @foreach ($item->groups as $group)
                                                <div wire:key='{{ $group->id }}' class="flex flex-row gap-3">
                                                    ...
                                                    <span
                                                        ...
                                                        @click="openCEmodal = true" data-modal-target="CEmodal"
                                                        data-modal-toggle="CEmodal">

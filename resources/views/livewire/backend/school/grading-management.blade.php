                ...
                <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);" x-cloak
                    ...
                    <div class="flex items-center justify-between space-x-4">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                            {{ $this->editable_item ? 'Edit' : 'Create' }} Grading for
                        </h3>
                                    ...
                                    <div class="p-6 space-y-6 h-full">
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div class="">
                                                ...
                                                <input wire:model.blur='grade_name' type="text"
                    ...
                    @foreach ($grades as $key => $item)
                        <tr wire:key='{{ $item->id }}' class="border-b">
                            ...
                            <td class="p-3 al flex justify-end items-center gap-1.5 flex-wrap">
                                ...
                                <a href="{{ route('school.grading-rule', ['id' => $item->id]) }}"
                                    class="px-2 py-1 rounded-sm bg-emerald-500 dark:bg-emerald-700 cursor-pointer flex w-max align-center justify-center">
                                    <i data-lucide="ruler" class="w-4 me-1"></i> Rules
                                </a>
                                <button

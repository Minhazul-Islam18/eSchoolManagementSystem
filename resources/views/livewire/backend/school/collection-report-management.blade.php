<div>
    <main class="container py-10">
        ...
        <button type="button" id="print"
            class="px-9 py-3 text-white font-medium text-lg rounded bg-sky-600 flex gap-3 mt-3 mb-4">
            {{ 'Print' }}
        ...
        <div class=" border-dashed border-4 rounded-lg py-8 px-4 mt-4 border-orange-400" id="reportTable">
            @if (!empty($paginatedData))
                <div class=""
                    ...
                    <div class="flex w-100">
                        <div class=" w-3/12 flex justify-center border-r border-white">
                            <img class="w-[130px]" src="/storage/{{ $school->institute_logo }}" alt="">
                        </div>
                ...
                <div class="relative overflow-x-auto">
                    ...
                    <table
                        class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 print:border pt-2 mt-1 print:py-5 print:my-5">

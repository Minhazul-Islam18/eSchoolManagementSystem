...
class ThemeCustomizer {
            ...
            e =
                (e &&
                    e.addEventListener("click", function (e) {
                        const isLightMode = "light" === n.config.theme;
                        $(b)
                            .toggleClass("light", !isLightMode)
                            .toggleClass("dark", isLightMode);
    ...
    init() {
        this.initConfig(),
            ...
            this.adjustLayout(),
            this.setSwitchFromConfig();
        //This is for set theme in initial load or refresh
        if ("light" === this.config.theme) {

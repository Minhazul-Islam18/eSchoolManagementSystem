...
return [
    ...
    "bkash_app_key"     => env("BKASH_APP_KEY", "6vp6myFwriGvJ6D70fkrrQaatc"),
    "bkash_app_secret" => env("BKASH_APP_SECRET", "63Ec35so66ZYj7V3asSkJxWFo3AZLJ6gTfYlDNumT2tPSKRqfsEL"),
    "bkash_username"      => env("BKASH_USERNAME", "01911139411"),
    "bkash_password"     => env("BKASH_PASSWORD", "X}Uj2Z!lx8K"),
    "callbackURL"     => env("BKASH_CALLBACK_URL", "http://127.0.0.1:8000/bkash/callback"),
    'timezone'        => 'Asia/Dhaka',
